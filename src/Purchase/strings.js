...
const strings = new LocalizedStrings({
  en: {
    ...
    payments: "Payments",
    paymentsInfo: "The application uses Klarna-payments. Get to know the payment method",
    ...
    payments: "Maksut",
    paymentsInfo: "Verkkosivulla on käytössä Klarna-maksu. Tutustu maksutapaan",
